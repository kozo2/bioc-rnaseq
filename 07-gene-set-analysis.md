...
Unit: microseconds
 ...
 fisher 248.474 253.723 264.93860 256.8995 269.1725 602.875   100
  hyper   1.493   1.728   2.52492   2.0740   3.1410   7.103   100
```
...
``` output
GeneSetCollection
  names: 10qA1, 10qA2, ..., 10qB2 (6 total)
  unique identifiers: Epm2a, Esr1, ..., LOC118567842 (681 total)
  types in collection:
...
``` output
--> Expected input gene ID: 110109,224008,22042,50931,66991,233406
```
